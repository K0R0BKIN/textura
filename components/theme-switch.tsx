      ...
      <DropdownMenuTrigger
        render={
          <Button
            variant="ghost"
            size="icon-lg"
            className="text-foreground dark:text-muted-foreground rounded-full hover:bg-(--sand-a3) aria-expanded:bg-transparent aria-expanded:hover:bg-(--sand-a3) dark:hover:bg-(--sand-1)"
          >
